...
public class CustomCSSSelector {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.className("form-control private-form__control login-email")).sendKeys("Swapna");
		//driver.findElement(By.xpath("//input[@class='form-control private-form__control login-email']")).sendKeys("Swapna");
		//driver.findElement(By.cssSelector(".form-control.private-form__control.login-email")).sendKeys("Swapna");
		
		//htmltag[@prop='value']  for xpath 
		// htmltag[prop='value']
		...
		// div.input-group input --> 3  direct + indirect 
		// div.input-group > input --> 2  here input is direct child to div
		
		//in xpath //  it is direct and indirect
		//  / means only direct
...
//		}
		...
		// input[id*='user'] --contains in xpath
		// input[id^='user'] --starts with in xpath
		// input[id$='name'] --ends with in xpath
		
		//comma in css:
		// input#username, input#password, button#loginBtn
		//#username, #password, #loginBtn, span.buttonText   - 4
